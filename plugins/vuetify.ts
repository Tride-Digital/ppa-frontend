      ...
      themes: {
        light: {
          colors: {
            ...
            'services-nav-bg-start': '#f8f9fa',
            'services-nav-bg-end': '#e9ecef',
            'services-nav-border': 'rgba(255, 255, 255, 0.2)',
            'services-nav-item-bg': '#ffffff',
            'services-nav-item-border': 'rgba(0, 0, 0, 0.05)',
            'services-nav-item-shadow': 'rgba(0, 0, 0, 0.05)',
            'services-nav-item-shadow-hover': 'rgba(0, 0, 0, 0.15)',
        ...
        dark: {
          colors: {
            ...
            'services-nav-bg-start': '#2d3748',
            'services-nav-bg-end': '#1a202c',
            'services-nav-border': 'rgba(255, 255, 255, 0.1)',
            'services-nav-item-bg': '#374151',
            'services-nav-item-border': 'rgba(255, 255, 255, 0.1)',
            'services-nav-item-shadow': 'rgba(0, 0, 0, 0.3)',
            'services-nav-item-shadow-hover': 'rgba(0, 0, 0, 0.4)',
            'service-card-bg': '#1f2937',
          },
        },
      },
    },
