  ...
  <div class="directory-page">
    ...
    <section class="hero-section">
      <v-container>
        <v-row>
          <v-col cols="12" md="8">
            <h1 class="section-title">Public Directory</h1>
            <p class="section-subtitle">
              Find verified service providers across Sri Lanka using search + filters (no heavy loading).
            </p>
          </v-col>
        </v-row>
      </v-container>
        ...
        <v-row>
          ...
          <v-col cols="12" lg="8">
            ...
            <v-row v-else class="mt-4">
              <v-col v-for="p in providers" :key="p.id" cols="12" sm="6" md="6" lg="6" class="d-flex">
                <ProviderCard
                  class="flex-1-1-auto"
                  :provider="p"
